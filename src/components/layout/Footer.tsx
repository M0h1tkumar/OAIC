            ...
            <div className="lg:col-span-2 space-y-10">
              <div className="space-y-6">
                <Link href="/" className="inline-block group">
                  <Image src="/images/images/logo.png" alt="OAIC 2026 Logo" className="h-16 w-auto brightness-0 invert opacity-90 transition-opacity group-hover:opacity-100" width={168} height={56} priority />
                </Link>
